...
if __name__ == '__main__':
    ...
    # Training settings
    parser.add_argument('--dataset', type=str, default=None, choices=['CelebA', 'RaFD', 'Both'])
    ...
    parser.add_argument('--input_label', nargs='+', type=int, default=None)

    # Sample settings
    parser.add_argument('--sample_attributes', type=str, nargs='+', default='')

    # Misc
    parser.add_argument('--mode', type=str, default='train', choices=['train', 'test', 'inference', 'sample'])
